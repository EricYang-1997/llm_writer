...
from neo4jquery import LlamaIndexChatWrapper, load_existing_graph_index
...
class Gradio_Events:
    ...
    def submit(state_value):
        ...
        try:
            ...
            response_generator = wrapper.chat(llama_messages, stream=True)
            
            full_response = ""
            for chunk_content in response_generator:
...
#chatbot {
  ...
  font-family: "Microsoft YaHei", "SimHei", "Segoe UI", Tahoma, Geneva, Verdana, sans-serif; /* 添加这行 */
}
...
with gr.Blocks(css=css) as demo:
    ...
    with ms.Application(), antdx.XProvider(
        ...
        with antd.Row(
            ...
            wrap=False, 
            elem_id="chatbot",
            elem_style={"height": "100vh"}  # 使用 elem_style 替代 style
        ):  
